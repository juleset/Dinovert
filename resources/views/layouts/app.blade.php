...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src='https://cdn.tiny.cloud/1/0or95003a3firajrju5iei6we361s9cut7plgmow1t9irbte/tinymce/5/tinymce.min.js' referrerpolicy="origin"></script>
                ...
                <div class=" justify-items-center">
                    ...
                    <div class="grid grid-cols-1 justify-items-center mb-2">
                        <div class="flex flex-wrap space-x-2">
                            ...
                            <a class="link" href="#" data-tippy-content="@twitter_handle"><svg class="h-6 fill-current text-white hover:text-oxley-500" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>Twitter</title>
                            ...
                            <a class="link" href="#" data-tippy-content="@github_handle"><svg class="h-6 fill-current text-white hover:text-oxley-500" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>GitHub</title>
                            ...
                            <a class="link" href="#" data-tippy-content="@unsplash_handle"><svg class="h-6 fill-current text-white hover:text-oxley-500" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <title>Unsplash</title>
                                    <path d="M7.5 6.75V0h9v6.75h-9zm9 3.75H24V24H0V10.5h7.5v6.75h9V10.5z"></path>
                                </svg></a>
                            <a class="link" href="#" data-tippy-content="@dribble_handle"><svg class="h-6 fill-current text-white hover:text-oxley-500" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="link" href="#" data-tippy-content="@instagram_handle"><svg class="h-6 fill-current text-white hover:text-oxley-500" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="link" href="#" data-tippy-content="@youtube_handle"><svg class="h-6 fill-current text-white hover:text-oxley-500" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <title>YouTube</title>
